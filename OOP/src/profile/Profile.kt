...
fun main() {
    ...
    val first: Person = Person(name = firstName, height = firstHeight, weight = firstWeight)
    val second: Person = Person(name = secondName, height = secondHeight, weight = secondWeight)
    first.age = firstAge
